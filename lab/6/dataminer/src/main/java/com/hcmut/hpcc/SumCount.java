...
/**
 * SumCount is a utility wrapper around two values for computing the mean of a
 * dataset. The two values are: - the sum of the values - the number of values
 * summed so that dividing the first by the second will give us the mean.
 */
